...
💡Также можешь получить советы по питанию и выбрать одно из направлений, в котором хочешь стать лучше. А наша программа даст тебе чёткие шаги по достижению следующих целей: 
1) если ты хочешь меньше уставать и не болеть
2) если ты хочешь держать свое тело в хорошей форме
3) если ты хочешь быть более продуктивным`, options);
});
